...
@Component({
  selector: 'app-editprofile-designer',
  templateUrl: './editprofile-designer.component.html',
  styleUrls: ['./editprofile-designer.component.css']
})
export class EditprofileDesignerComponent implements OnInit {
